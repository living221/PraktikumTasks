package YandexPraktikumTasks.JavaCore1.sprint_7.TimeAndDate.task02;
...
class Practicum {
    ...
    public static void main(String[] args) {
        ...
        if (calculateDuration(timeToGoToSleep, timeToWakeUp, TimeUnits.MILLIS) < sleepGoalHours * ONE_HOUR_MILLIS) {

package YandexPraktikumTasks.JavaCore1.sprint_5.hashtables.task02;
...
public class Practicum {
    ...
    private void newOrder(String clientName) {
        ...
        Integer ordersCount = orders.getOrDefault(clientName, 0);
        orders.put(clientName, (ordersCount + 1));
    }
    ...
    private void printStatistics() {
        ...
        for (Map.Entry<String, Integer> entry : orders.entrySet()) {
            ordersNumber += entry.getValue();
            System.out.println("Заказов от " + entry.getKey() + ": " + entry.getValue());
        }
        System.out.println("Всего заказов: " + ordersNumber);
    }
}
...
public class Praktikum {
    ...
    private static void changePointAndDistance(int points, int distance, Car car) { // реализуйте метод
    ...
    private static int makeRace(Car userCar, Car opponentCar, int distance) {
        ...
        boolean shortRaceWin = ((userCar.acceleration > opponentCar.acceleration) && (distance <= 15)); // на короткой дистанции
        boolean longRaceWin = ((userCar.maxSpeed > opponentCar.maxSpeed) && (distance > 50)); // на длинной дистанции
        ...
        if (shortRaceWin || longRaceWin ) { // если победил на короткой или на длинной дистанции
            ...
            double result = Double.max(userCar.maxSpeed, opponentCar.maxSpeed);
            return (int) result;
